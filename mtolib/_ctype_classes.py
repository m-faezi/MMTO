...
def init_classes(d_type):
    ...
    MtHeap._fields_ = [("entries", ct.POINTER(MtPixel)), ("num_entries", ct.c_int32), ("max_entries", ct.c_int32)]
    MtStack._fields_ = [("entries", ct.POINTER(MtPixel)), ("num_entries", ct.c_int32), ("max_entries", ct.c_int32)]
    MtConnectivity._fields_ = [("neighbours", ct.POINTER(ct.c_int)), ("height", ct.c_int), ("width", ct.c_int)]
